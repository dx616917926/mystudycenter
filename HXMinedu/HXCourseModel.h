...
@property(nonatomic, strong) NSString *ShowKJ;            //是否显示课件
@property(nonatomic, strong) NSString *ShowZY;            //是否显示作业
@property(nonatomic, strong) NSString *ShowQM;            //是否显示期末考试
...
@property(nonatomic, strong) NSString *canLearning;          //是否到时间可以学习和考试
