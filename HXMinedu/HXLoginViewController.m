...
//    .heightIs(14);
    ...
    if (kHXAPPEdition == kHXReleaseEdition) {
        ...
        self.userNameTextField.text = @"141414200001090386";
        self.passwordTextField.text = @"141414200001090386";//141414201201020001//500243197908029235//43022320030327006X//530125197405062014//141414200001090386
    }
#endif
}
