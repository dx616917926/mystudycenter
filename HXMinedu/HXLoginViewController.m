...
#ifdef DEBUG
    //测试账号
    loginView.passWordTextField.text =  @"430111199909090952";// @"430718199210109002";  @"430621199908080707"   @"430111199909090952" @"222211199504070707" @"430381200306190101"
    loginView.userNameTextField.text =  @"430111199909090952";
#endif
}
