...
#ifdef DEBUG
    //测试账号
    loginView.passWordTextField.text = @"431281199002210804";// @"43108120041016002X";// @"436201199808050605";  @"430621199908080707"   @"430111199909090952" @"436210199807070740" @"430381200306190101"
    loginView.userNameTextField.text =   @"431281199002210804";
#endif
}
