...
#ifdef DEBUG
    //测试账号
    loginView.passWordTextField.text =  @"436521199612151715";// @"430481198904251252";// @"436201199808050605";  @"430621199908080707"   @"430111199909090952" @"436210199807070740" @"430381200306190101"
    loginView.userNameTextField.text =   @"436521199612151715";
#endif
}
