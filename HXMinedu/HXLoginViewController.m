...
#ifdef DEBUG
    //测试账号
    loginView.passWordTextField.text = @"43042119960301954X";// @"43108120041016002X";// @"436201199808050605";  @"430621199908080707"   @"430111199909090952" @"436210199807070740" @"430381200306190101"
    loginView.userNameTextField.text =   @"43042119960301954X";
#endif
}
