...
@interface HXLNZTViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation HXLNZTViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (self.isHistory) {
        ...
        cell.cellType = HXLiNianZhenTiReportType;
        return cell;
    }else{
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vc.cellType = HXLiNianZhenTiReportType;
