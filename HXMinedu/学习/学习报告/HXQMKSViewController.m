...
@interface HXQMKSViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation HXQMKSViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (self.isHistory) {
        ...
        cell.cellType = HXQiMoKaoShiReportType;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vc.cellType = HXQiMoKaoShiReportType;
    if (indexPath.row<self.learnCourseItemList.count) {
