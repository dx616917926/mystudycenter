...
-(void)createUI{
    ...
    self.sc_navigationBar.title = (self.PDFType== 1?@"收款凭证":(self.PDFType== 2?@"交易凭证":@"发票凭证"));
...
-(UIButton *)downLoadBtn{
    if (!_downLoadBtn) {
        ...
        ///查看凭证 PDFType: 1、收款凭证     2、交易凭证    3、发票凭证
        [_downLoadBtn setTitle:(self.PDFType == 1?@"下载收款凭证":(self.PDFType == 2?@"下载交易凭证":@"下载发票凭证")) forState:UIControlStateNormal];
