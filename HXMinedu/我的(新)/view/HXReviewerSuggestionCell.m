...
@interface HXReviewerSuggestionCell ()
...
@implementation HXReviewerSuggestionCell
...
-(void)setStudentRefundDetailsModel:(HXStudentRefundDetailsModel *)studentRefundDetailsModel{
    ...
    self.contentLabel.text = [HXCommonUtil isNull:studentRefundDetailsModel.reviewerRemark]?@"":studentRefundDetailsModel.reviewerRemark;
